...
package com.thedeveloperworldisyours.takesavepicture.photo
...
import com.thedeveloperworldisyours.takesavepicture.R
import java.io.File
import java.util.*
...
class Camera2BasicFragment : Fragment(), View.OnClickListener,
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        file = File(requireActivity().getExternalFilesDir(null), "$pictureID$PIC_FILE_NAME")
    }
    ...
    private fun unlockFocus() {
        try {
            ...
            ((activity)as CameraActivity).myFinish(pictureID)
        } catch (e: CameraAccessException) {
            Log.e(TAG, e.toString())
        }
